...
public static Double kLaunchBoxAnglerKpHoriz = 0.11/20;
...
public static Double kLaunchBoxMinimumMovePowerVert = .17;
public static Double kLaunchBoxMinimumMovePowerHoriz = .23;
