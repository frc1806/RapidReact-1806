...
public static Double kLaunchBoxAnglerKpHoriz = 0.09/20;
public static Double kLaunchBoxAnglerKpVert = 0.05/20;
...
public static Double kLaunchBoxMinimumMovePowerVert = .18;
public static Double kLaunchBoxMinimumMovePowerHoriz = .22;
