...
public class Constants {
    ...
    public final static double kDriveHighGearVelocityKp = .00023109; //.0004;//.08;//.16; //1.01;
    ...
    public final static double kDriveHighGearVelocityKf = 0.0000000;//.0175; //.035; //0.21; //.025;
