...
public class DriveTrainSubsystem implements Subsystem {
	...
	public DriveTrainSubsystem() {
		...
		leaderLeft = new CANSparkMax(RobotMap.leftLeader, MotorType.kBrushless);
		leaderRight = new CANSparkMax(RobotMap.rightLeader, MotorType.kBrushless);

		leftA = new CANSparkMax(RobotMap.leftFollowerA, MotorType.kBrushless);
		rightA = new CANSparkMax(RobotMap.rightFollowerA, MotorType.kBrushless);

		leftB = new CANSparkMax(RobotMap.leftFollowerB, MotorType.kBrushless);
		rightB = new CANSparkMax(RobotMap.rightFollowerB, MotorType.kBrushless);
